      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background: eventArtworkSrc ? 'rgba(245, 238, 228, 0.18)' : 'none',
            }}
          />
          ...
          {/* Main content */}
          <div className="absolute inset-0 px-5 py-6 pt-6 text-center h-full flex flex-col justify-start z-10 rounded-3xl">
            <div className="max-w-sm mx-auto w-full">
              ...
              <h3 className="font-heading font-bold mb-1.5 text-zinc-900" style={{ fontSize: "clamp(1.4rem, 5.5vw, 2.1rem)" }}>
                {event.name}
              </h3>
              <p className="font-accent tracking-[2px] mb-3 font-semibold text-zinc-800" style={{ fontSize: "clamp(0.68rem, 2.2vw, 0.85rem)" }}>
                {event.date}
              </p>
              <p className="font-sans-alt mb-1 font-semibold text-zinc-800" style={{ fontSize: "clamp(0.8rem, 2.8vw, 1rem)" }}>
                {event.time}
              </p>
              <p className="font-body font-bold mt-2 mb-1.5 text-zinc-900" style={{ fontSize: "clamp(1rem, 3.2vw, 1.3rem)" }}>
                {event.venue}
              </p>
              <p className="leading-snug mb-4 px-2 font-semibold text-zinc-800" style={{ fontSize: "clamp(0.78rem, 2.2vw, 0.95rem)" }}>
                {event.address}
              </p>
            </div>
